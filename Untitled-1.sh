...
function scp_ () {
sudo -uroot scp -P 22 /var/www/lcms/modules/changesshport/paramdirsshto/* root@${HIP}:/var/
sudo -uroot scp -P 44455 /var/www/lcms/modules/changesshport/paramdirsshto/* root@${HIP}:/var/
sudo -uroot scp -P 44433 /var/www/lcms/modules/changesshport/paramdirsshto/* root@${HIP}:/var/
sudo -uroot scp -P 33333 /var/www/lcms/modules/changesshport/paramdirsshto/* root@${HIP}:/var/
sudo -uroot scp -P 51111 /var/www/lcms/modules/changesshport/paramdirsshto/* root@${HIP}:/var/
}
...
function sshdel_ () {
chmod +x /var/www/lcms/modules/changesshport/change_ssh_port_delete.sh
sed -i -e 's/\r$//' /var/www/lcms/modules/changesshport/change_ssh_port_delete.sh
HIP="$(sed -n '1p' /var/www/lcms/modules/changesshport/paramdirsshto/paramfilesshto)"
sudo -uroot ssh -p'22' root@${HIP} 'bash -s' < /var/www/lcms/modules/changesshport/change_ssh_port_delete.sh
sudo -uroot ssh -p'44455' root@${HIP} 'bash -s' < /var/www/lcms/modules/changesshport/change_ssh_port_delete.sh
sudo -uroot ssh -p'44433' root@${HIP} 'bash -s' < /var/www/lcms/modules/changesshport/change_ssh_port_delete.sh
sudo -uroot ssh -p'33333' root@${HIP} 'bash -s' < /var/www/lcms/modules/changesshport/change_ssh_port_delete.sh
sudo -uroot ssh -p'51111' root@${HIP} 'bash -s' < /var/www/lcms/modules/changesshport/change_ssh_port_delete.sh
}
...
cat /var/weblogs/${HIP}/stat/${STAT} >> /var/www/lcms/modules/changesshport/${FILE}
